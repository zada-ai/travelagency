...
<div class="min-h-screen bg-slate-50 py-8 sm:py-12">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
            ...
            {{-- Success Header --}}
            <div class="bg-gradient-to-r from-blue-600 to-indigo-600 px-6 sm:px-8 py-9 text-white">
                ...
                <div class="flex flex-col items-center text-center">
                    ...
                    <p class="text-xs sm:text-sm font-bold uppercase tracking-[0.2em] text-blue-100">
                        Travel Agent Portal
                    </p>
                    ...
                    <p class="mt-3 max-w-xl text-sm sm:text-base text-blue-100 leading-relaxed">
                        The flight booking has been created successfully and is now available in your bookings.
                    </p>
            ...
            <div class="p-6 sm:p-8">
                ...
                <div class="rounded-2xl border border-slate-200 bg-slate-50 p-5 sm:p-6">
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        ...
                        <span class="inline-flex w-fit items-center gap-2 rounded-full bg-emerald-50 px-3 py-1.5 text-xs font-bold text-emerald-700">
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-slate-600 leading-relaxed">
                                Flight booking #{{ $flightBooking->id }} has been added to your booking history.
                                You can return to your bookings to review the reservation.
                            </p>
                        </div>
                ...
                <div class="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div class="rounded-xl border border-slate-200 bg-white p-4">
                        ...
                        <p class="mt-1 text-sm font-bold text-slate-900 break-all">
                            {{ $flightBooking->reference ?? $flightBooking->reference_number ?? 'N/A' }}
                        </p>
                    </div>
                    ...
                    <div class="rounded-xl border border-slate-200 bg-white p-4">
                        ...
                        <span class="mt-1 inline-flex px-3 py-1 rounded-full text-xs font-bold
                            {{ in_array(strtolower((string) $flightBooking->status), ['confirmed', 'approved'])
                                ? 'bg-emerald-50 text-emerald-700'
                                : (in_array(strtolower((string) $flightBooking->status), ['cancelled', 'rejected'])
                ...
                <div class="mt-8 pt-6 border-t border-slate-200">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3">
                        ...
                        <a href="{{ route('travel-agents.bookings') }}"
        ...
        <p class="mt-5 text-center text-xs text-slate-400">
            Keep booking ID
            <strong class="text-slate-600">#{{ $flightBooking->id }}</strong>
