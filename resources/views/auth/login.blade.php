...
@section('content')
    <div>
        ...
        <div class="flex items-center gap-3">
            ...
            <div class="leading-tight">
                ...
                <span
                    class="block text-lg font-bold tracking-tight font-display"
                    style="color:#0F172A;"
                >
                    Umrah ERP
                </span>
        ...
        <div class="mt-9 sm:mt-12">
            ...
            <h1
                class="text-[26px] sm:text-3xl font-semibold tracking-tight font-display"
                style="color:#0F172A;"
            >
                Welcome back
            </h1>
        ...
        @if ($errors->any())
            ...
            <div
                class="mt-6 rounded-2xl p-4 text-xs border"
                style="
                    background:#FBEAEA;
                    border-color:#F0C6C6;
                    color:#8A2E2E;
        ...
        >
                ...
                <div class="relative">
                    ...
                    <input
                        ...
                        onfocus="
                            ...
                            this.style.boxShadow='0 0 0 4px rgba(37,99,235,0.14)';
                        "
                        onblur="
            ...
            <div>
                ...
                <div class="flex justify-between items-center mb-2">
                    ...
                    @if (Route::has('password.request'))
                        ...
                        <a
                            ...
                            class="text-xs font-bold transition-colors hover:text-emerald-600"
                            style="color:#2563EB;"
                        >
                            Forgot password?
                        </a>
                ...
                <div class="relative">
                    ...
                    <button
                        ...
                        "
                        class="absolute right-4 top-1/2 -translate-y-1/2 transition-colors hover:text-blue-600"
                        style="color:#64748B;"
            ...
            <button
                ...
                onmouseover="
                    ...
                    this.style.boxShadow='0 16px 32px -10px rgba(37,99,235,0.55)';
                "
                onmouseout="
                    this.style.background='#2563EB';
                    this.style.boxShadow='0 14px 30px -10px rgba(37,99,235,0.45)';
                "
            >
    ...
    {{-- ==================== REGISTER FOOTER ==================== --}}
    <div
        class="mt-10 pt-6 border-t text-center"
    ...
    >
        ...
        >
            ...
            <a
                href="{{ route('register') }}"
                class="font-extrabold transition-colors hover:text-blue-600"
                style="color:#059669;"
            >
