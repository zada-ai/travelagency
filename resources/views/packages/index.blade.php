...
<body class="min-h-screen text-slate-700 antialiased bg-slate-50">
                ...
                <div class="bg-white rounded-3xl p-6 md:p-8 shadow-xs border border-slate-200/80 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    ...
                    <div class="flex items-center gap-3 w-full md:w-auto">
                        {{-- <div class="bg-slate-50 border border-slate-200 px-4 py-2.5 rounded-2xl text-center flex-1 md:flex-initial">
                            ...
                            <span class="text-lg font-extrabold text-slate-800">{{ isset($packages) ? count($packages) : 6 }} Listed</span>
                        </div> --}}
                                ...
                                <div>
                                    ...
                                    <div class="bg-white rounded-2xl p-4 border border-slate-100 shadow-sm mb-5 text-center">
                                        ...
                                        <div class="flex justify-center items-center gap-3">
                                           ...
                                           <span class="font-extrabold text-slate-800 text-lg">
    {{ $pkg->available_seats ?? 0 }} / {{ $pkg->total_seats ?? 0 }}
</span>
</div>
                                    </div>
    ...
    @endphp
    <a href="{{ $packageBookRoute }}"
       class="w-full inline-flex items-center justify-center px-5 py-3.5 bg-blue-600 hover:bg-blue-700 active:scale-[0.98] text-white rounded-xl font-bold text-sm shadow-xl shadow-blue-500/25 transition gap-2">
...
@else
    <button type="button"
            disabled
            class="w-full inline-flex items-center justify-center px-5 py-3.5 bg-slate-300 text-slate-500 rounded-xl font-bold text-sm cursor-not-allowed gap-2">
