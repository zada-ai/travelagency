...
<head>
    ...
    <title>Hotel Booking | Hujaj Umrah ERP</title>
    ...
    <style>
        ...
        .custom-shadow {
            box-shadow: 0 10px 30px -5px rgba(0, 0, 0, 0.04), 0 20px 40px -10px rgba(0, 0, 0, 0.02);
        }
    </style>
</head>
<body class="min-h-screen text-slate-700 antialiased bg-slate-50">
    ...
    <div class="min-h-screen">
        <!-- Main Layout Grid Split (Matching Agent & Customer Portals) -->
        <div class="grid min-h-screen xl:grid-cols-[280px_1fr] relative">
            ...
            <main class="flex-1 p-4 md:p-8 overflow-y-auto space-y-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 items-end">
                            ...
                            <div class="w-full">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="check_in" value="{{ old('check_in', $checkIn?->format('Y-m-d') ?? '') }}" class="w-full pl-10 pr-3 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm font-semibold text-slate-800 h-[50px] focus:ring-2 focus:ring-blue-500/20 focus:border-blue-600 transition" id="checkIn" placeholder="YYYY-MM-DD" readonly>
                                </div>
                            </div>
                            ...
                            <div class="w-full">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="check_out" value="{{ old('check_out', $checkOut?->format('Y-m-d') ?? '') }}" class="w-full pl-10 pr-3 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm font-semibold text-slate-800 h-[50px] focus:ring-2 focus:ring-blue-500/20 focus:border-blue-600 transition" id="checkOut" placeholder="YYYY-MM-DD" readonly>
                                </div>
                            </div>
                ...
                <!-- Main Section: Filters Sidebar + Results List -->
